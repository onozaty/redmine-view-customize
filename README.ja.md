...
* 最新バージョン : Redmine 4.0.x 以降
* 3.5.4 : Redmine 3.1.x から 3.4.x、4.0.x 以降
...
もしこのプロジェクトが役に立つと思われましたら、継続的な開発をサポートするために⭐をお願いします。
また、このプロジェクトの維持と持続に貢献してくださる[スポンサー](https://github.com/sponsors/onozaty)を募集しています。

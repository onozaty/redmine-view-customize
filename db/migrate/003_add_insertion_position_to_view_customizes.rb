class AddInsertionPositionToViewCustomizes < ActiveRecord::Migration
  def up
    ...
    ActiveRecord::Base.connection.execute(
        "UPDATE view_customizes SET customize_type = 'stylesheet' WHERE customize_type_old = 2")
  ...
  def down
    ...
    ActiveRecord::Base.connection.execute(
        "UPDATE view_customizes SET customize_type = 1 WHERE customize_type_new = 'stylesheet'")
